...
{
    public partial class LtrNotificationItemsAuditConfiguration : IEntityTypeConfiguration<LtrNotificationItemsAudit>
    {
        public void Configure(EntityTypeBuilder<LtrNotificationItemsAudit> entity)
        {
            entity.HasKey(e => e.NotificationItemAuditId);

            entity.ToTable("LTR_NotificationItems_Audit");

            entity.Property(e => e.NotificationItemAuditId).HasColumnName("NotificationItemAuditID");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<LtrNotificationItemsAudit> entity);
    }
}
