...
{
    public partial class DemoSraccountAddressConfiguration : IEntityTypeConfiguration<DemoSraccountAddress>
    {
        public void Configure(EntityTypeBuilder<DemoSraccountAddress> entity)
        {
            entity.HasKey(e => e.AccountId).HasName("PK_DemoAccountID");

            entity.ToTable("Demo_SRAccountAddresses");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<DemoSraccountAddress> entity);
    }
}
