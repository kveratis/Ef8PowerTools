...
{
    public partial class VwDispenseConfiguration : IEntityTypeConfiguration<VwDispense>
    {
        public void Configure(EntityTypeBuilder<VwDispense> entity)
        {
            entity
                .HasNoKey()
                .ToView("vw_Dispenses");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwDispense> entity);
    }
}
