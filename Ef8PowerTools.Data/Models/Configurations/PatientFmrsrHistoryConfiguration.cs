...
{
    public partial class PatientFmrsrHistoryConfiguration : IEntityTypeConfiguration<PatientFmrsrHistory>
    {
        public void Configure(EntityTypeBuilder<PatientFmrsrHistory> entity)
        {
            entity.ToTable("PatientFMRSR_History", tb => tb.HasTrigger("TR_PatientFMRSR_History_Audit"));

            entity.HasIndex(e => new { e.Srid, e.EnrollmentDate }, "IX_NCI_PATFMHIS_SRID_EnrollmentDate");

            entity.HasIndex(e => new { e.ProgramId, e.Deleted }, "Program_SRID_SHID");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<PatientFmrsrHistory> entity);
    }
}
