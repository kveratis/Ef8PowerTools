...
{
    public partial class PatientRemsAuditConfiguration : IEntityTypeConfiguration<PatientRemsAudit>
    {
        public void Configure(EntityTypeBuilder<PatientRemsAudit> entity)
        {
            entity.ToTable("PatientREMS_Audit", tb => tb.HasTrigger("TR_PatientREMS_Audit_Permission"));

            entity.Property(e => e.PatientRemsAuditId).HasColumnName("PatientREMS_AuditID");
            ...
            entity.Property(e => e.CreatedByRems)
                .HasMaxLength(50)
                .IsUnicode(false)
            ...
            entity.Property(e => e.CreatedRems)
                .HasColumnType("datetime")
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<PatientRemsAudit> entity);
    }
}
